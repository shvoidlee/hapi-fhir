...
public class Bundle extends BaseBundle /* implements IElement */{
	...
	public void setLinkBase(String baseURI){
		myLinkBase = new StringDt(baseURI);
	}
	...
	public void setLinkNext(String nextURI){
		myLinkNext = new StringDt(nextURI);
	}
	...
	public void setLinkPrevious(String previousURI){
		myLinkPrevious = new StringDt(previousURI);
	}
